...
public class Part1 {
    ...
    private static  BigInteger modExp(BigInteger a, BigInteger exponent, BigInteger N) {
        ...
        for (int i = expBitlength - 2; i >= 0; i--) {
            result = obj.mog_mod_mul(result,result,N,temp[0],temp[1],temp[2],1);
            if (exponent.testBit(i)) {
                result = obj.mog_mod_mul(result,a,N,temp[0],temp[1],temp[2],1);
            }
        }
        return result;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" Time = "+(System.nanoTime()-startTime)/1000000+ " msec");
    }
